...
<head>
    ...
    <link rel="stylesheet" href="css\login_model.css">

</head>
<body>

<button onclick="document.getElementById('id03').style.display='block'">test</button>
    ...
    <div class="container">
      <table style="border-style: none;">
        ...
        <tr>
          ...
          <td> 
            <label for="dob"><b>DOB</b></label> <input class="form-control-inline" type="date" name="dob" required>
          </td>
        </tr>
        <tr>
          <td>
